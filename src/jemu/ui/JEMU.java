...
public class JEMU extends Applet implements   KeyListener, MouseListener, ItemListener,
  ActionListener, FocusListener, Runnable, DriveListener, MouseMotionListener
{
 ...
 /* protected JComboBox          jcbComputer      = new JComboBox();
  protected JComboBox          jcbDrive         = new JComboBox();
  protected JComboBox          jcbImage         = new JComboBox();
  protected JComboBox          driveHead        = new JComboBox(new String[] { "Head 0", "Head 1" });*/
...
public void init() {
    ...
    stopRec.setBorder(new BevelBorder(BevelBorder.RAISED));
      ...
      int selectedValue = JOptionPane.showOptionDialog(this, object, "Please choose:",
  ...
  public void autorun(){
    ...
    if (autoloadprog != null){
        ...
        if (autoloadprog.equals("launchtape")){
        runner =true;
        stopsimple = 1;
        //loadprogtimer = 1;
  ...
  public void reBoot(){
    ...
    if (autoloadprogram != null){
        ...
        if (autoloadprogram.equals("launchtape")){
        runner =true;
        stopsimple = 1;
        //loadprogtimer = 1;
        jemu.system.cpc.CPC.tapestarttimer = 1;
  ...
  public void reportBug(){
      ...
      String checkthis = ""+Util.hex((short)Util.random(0xffff));
            ...
            Font font = new Font("Courier", 1, 10);
                ...
                Object[] message = {"Security code" , checkcode , "Your name:", UserName, "Your email:", Email,
                "Your message" , content2, "Enter security code" , entercode
                };
                ...
                if (Email.getText().endsWith(".com") ||
                        Email.getText().endsWith(".de") ||
                        Email.getText().endsWith(".fr") ||
                        Email.getText().endsWith(".gr") ||
                        Email.getText().endsWith(".dk") ||
                        Email.getText().endsWith(".es") ||
                        Email.getText().endsWith(".uk") ||
                        Email.getText().endsWith(".fn") ||
                        Email.getText().endsWith(".ro") ||
                        Email.getText().endsWith(".ru") ||
                        Email.getText().endsWith(".it") ||
                        Email.getText().endsWith(".tk")){
  ...
  public void start() {
    ...
    if (labelwidth <=0)
     ...
     // display.setDoubleBuffered(true);
      ...
      switch(Switches.computername){
              case 0 : cname0.setState(true); break;
              case 1 : cname1.setState(true); break;
              case 2 : cname2.setState(true); break;
              case 3 : cname3.setState(true); break;
              case 4 : cname4.setState(true); break;
              case 5 : cname5.setState(true); break;
              case 6 : cname6.setState(true); break;
              case 7 : cname7.setState(true); break;
      }
    ...
    if (setComputers != null){
        ...
        setComputers = getParameter("COMPUTER" ,Computer.DEFAULT_COMPUTER);
        setComputer(setComputers, !(debug || pause));
    }}
      } else if (!(debug || pause)) {
        computer.start();
...
protected void processWindowEvent(WindowEvent we) {
    ...
    frame.setTitle("JavaCPC - Amstrad CPC Emulator        CPU:" + Switches.turbo*100+"%");
 ...
 protected boolean useBorderColor = false;
  public void update(){
      ...
      if (executable && !fullscreen){
          if (frame.getX() != screenXstored || frame.getY() != screenYstored){
     ...
     // System.out.println("Display double buffer is:"+display.isDoubleBuffered());
      ...
      if (executable)
          if (CPUspeed != Switches.turbo*100){
              ...
              frame.setTitle("JavaCPC - Amstrad CPC Emulator        CPU:" + CPUspeed+"%");
          }
      if (doAutoopen > 0){
          doAutoopen++;
          if (doAutoopen >= 2){
  ...
  public void autoBoot() {
      ...
      if (compsys.equals("CPC464"))
          loadFile("autoboot464.sna");
      else
      if (compsys.equals("CPC464PARA"))
          loadFile("autoboot464.sna");
      else
...
protected String fileName;
  ...
  public void keyPressed(KeyEvent e) {
    ...
    if (e.getKeyCode() == 0x2d)                             // - content to /
    ...
    /*  if (e.getKeyCode() == KeyEvent.VK_F1 && (alt)) {
        alt = false;
          setSimpleSized();
          return;
      }
      if (e.getKeyCode() == KeyEvent.VK_F2 && (alt)) {
        alt = false;
          setDoubleSized(true);
          return;
      }
      if (e.getKeyCode() == KeyEvent.VK_F3 && (alt)) {
        alt = false;
          setTripleSized(true);
          return;
      }
  ...
  public void showDebugger() {
    ...
    try {
      ...
      if (debugger == null) {
        this.debugger = (Debugger) Util.secureConstructor(Debugger.class, new Class[] {}, new Object[] {});
        this.debugger.setBounds(0, 0, 640, 480);
...
try{
     ...
     // this.jcbDrive.removeAllItems();
      ...
      //try {
       ...
       /* for (int i = 0; i < files.size(); i++) {
          this.jcbImage.addItem(files.elementAt(i));
        }
   ...
   /*   final Vector floppydrives = getDrives();
      for (int i = 0; i < floppydrives.size(); i++) {
        this.jcbDrive.addItem(floppydrives.elementAt(i));
      }
      if (Switches.computersys == 0) {
        this.jcbDrive.setSelectedIndex(-1);
      } else {
        this.jcbDrive.setSelectedIndex(0);
      }
*/
      if (debugger != null)
        debugger.setComputer(computer);
  ...
  public Vector getDrives() {
    ...
    final Vector result = floppydrives == 0 ? new Vector() : new Vector(floppydrives);
 ...
 // Switches.audioenabler = 0;
  ...
  public void actionPerformed(ActionEvent e) {
         ...
         if (e.getSource() instanceof MenuItem)
    {
       ...
       if (menuAdd.equals("Reset            Ctrl + F9")) reset();
       else
       if (menuAdd.equals("Reboot")) reBoot();
       else
       if (menuAdd.equals(extra1))
           new UpdateInfo("http://www.cpcgamereviews.com/a/index.html", "CPCGameReviews");
       else
       if (menuAdd.equals(extra2))
           new UpdateInfo("http://cpcgames.dirtyangels.eu", "Own CPC games archive");
       else
       if (menuAdd.equals(extra3))
       ...
       if (menuAdd.equals("About")){
        info();
       }
       else
       if (menuAdd.equals("Create new DSK")){
        if (executable)
                frame.setAlwaysOnTop(false);
                CreateDsk();
        if (executable)
       ...
       if (menuAdd.equals("Load...")){
           Switches.askDrive = true;
           loaddata();
       }
       else
       if (menuAdd.equals("Debugger")) showDebugger();
       else
       if (menuAdd.equals(CPUfollow)){
           if (followCPU)
               followCPU = false;
           else
               followCPU = true;
       ...
       if (menuAdd.equals("Boot CP/M")) computer.bootCPM();
       else
       if (menuAdd.equals(recordkeys)) RecInfo();
       else
       if (menuAdd.equals("ROM Setup")){
        if (executable)
                frame.setAlwaysOnTop(false);
                romsetter.setRoms();
        if (executable)
       ...
       if (menuAdd.equals("Java console")) Console.frameconsole.setVisible(true);
       else
       if (menuAdd.equals("Pause")) pausecheck();
       else
       if (menuAdd.equals("Eject all")){
           computer.setCurrentDrive(3);
           mediumeject();
           computer.setCurrentDrive(2);
           mediumeject();
       ...
       if (menuAdd.equals(checkup)){
           try{
           UpdateCheck();}
           catch (final Exception er){}
       }
       else
       if (menuAdd.equals(reportBug)){
           if (executable)
               frame.setAlwaysOnTop( false);
           reportBug();
           if (executable)
       ...
       if (menuAdd.equals(downl)){
           openWebPage("http://cpc-live.com/download.php?list.7");
       }
       else
       if (menuAdd.equals(homepage)){
           openWebPage("http://cpc-live.com");
       }
       else
       if (menuAdd.equals(sourceforge)){
           openWebPage("https://sourceforge.net/projects/javacpc");
       }
       else
       if (menuAdd.equals(showYM)){
        ymControl.setVisible(true);
       }
       else
       if (menuAdd.equals(showRec)){
        //new AudioRecorder();
           jemu.system.cpc.CPC.showAudioCapture = true;
       }
       else
       if (menuAdd.equals(showCap)){
           FileDialog filedia = new FileDialog((Frame) frame, "Save Animated Gif...", FileDialog.SAVE);
        filedia.setFile("*.gif");
       ...
       if (menuAdd.equals(df1sav)){
           computer.setCurrentDrive(1);
           Switches.dskcheck=true;
       }
       else
       if (menuAdd.equals(df2sav)){
           computer.setCurrentDrive(2);
           Switches.dskcheck=true;
       }
       else
       if (menuAdd.equals(df3sav)){
           computer.setCurrentDrive(3);
           Switches.dskcheck=true;
       }
       else
       if (menuAdd.equals(df0save)){
          computer.setCurrentDrive(0);
        if (executable)
                frame.setAlwaysOnTop(false);
                saveDsk();
       ...
       if (menuAdd.equals(screenShot))
           screentimer=1;
       else
       if (menuAdd.equals(digi)){
           Switches.digi=true;
       ...
       if (menuAdd.equals(digimc)){
           Switches.digimc=true;
       }
       else
       if (menuAdd.equals(digipg)){
           Switches.digipg=true;
       }
       else
           if (menuAdd.equals(catchSCR))
       ...
       if (menuAdd.equals(tapeopen)){
          jemu.system.cpc.CPC.TapeDrive.setVisible(true);
          jemu.system.cpc.CPC.tapedeck = true;
       }
       else
       if (menuAdd.equals(tapeLoad)){
          loadTape(false);
       }
       else
       if (menuAdd.equals(ejectTape)){
          tapeEject();
       }
       else
       if (menuAdd.equals(tapeLaunch)){
          loadTape(true);
       }
       else
       if (menuAdd.equals(tapeSave)){
          computer.tape_WAV_save();
       }
       else
           if (menuAdd.equals(tapeOptimize)){
           jemu.system.cpc.CPC.doOptimize = true;
           }
       else
       if (menuAdd.equals(tapeConvert)){
          computer.CDT2WAV();
       }
       else
       if (menuAdd.equals(makCDT)){
           makeCDT.makeCDT();
       }
       else
       if (menuAdd.equals(wav2cdt)){
          samp2cdt.samp2CDT();
       }
       else
       if (menuAdd.equals(df0insert)){
           Switches.askDrive = false;
          computer.setCurrentDrive(0);
          loaddata();
          computer.setCurrentDrive(0);
       ...
       if (menuAdd.equals(df0eject)){
           computer.setCurrentDrive(0);
           mediumeject();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df1eject)){
           computer.setCurrentDrive(1);
           mediumeject();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df2eject)){
           computer.setCurrentDrive(2);
           mediumeject();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df3eject)){
           computer.setCurrentDrive(3);
           mediumeject();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df0create)){
           computer.setCurrentDrive(0);
           CreateDsk();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df1create)){
           computer.setCurrentDrive(1);
            CreateDsk();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df2create)){
           computer.setCurrentDrive(2);
           CreateDsk();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df3create)){
           computer.setCurrentDrive(3);
           CreateDsk();
           computer.setCurrentDrive(0);
       }
       else
       if (menuAdd.equals(df0boot)){
           computer.bootDisk();
       }
       else
       if (menuAdd.equals(df1boot)){
           computer.bootDiskb();
       }
       else
       if (menuAdd.equals(Aoptions)){
          optionPanel.OptionPanel();
       }
       else
       if (menuAdd.equals(Oprinter)){
           CPCPrinter.MakeVisible();
       }
       else
           if (menuAdd.equals(loadTXT))
            Autotype.loadFile();
       else
       if (menuAdd.equals(Expansioninfo)){
           ExpansionInfo();
       }
       else
           if (menuAdd.equals(HexEdit))
            hexi = new HexEditor();
      else
          if (menuAdd.equals(snapshot))
              chooseSNA();
      else
          if (menuAdd.equals(binary))
              Switches.BINImport = true;
      else
          if (menuAdd.equals(export))
              Switches.export = true;
      else
          if (menuAdd.equals(cpcpalette))
              Switches.showPalette = true;
      else
          if (menuAdd.equals(poke))
              Switches.poke = true;
      else
          if (menuAdd.equals(ENkeys)){
              keys = "English keyboard  ";
              localkeys = "EN_EN";
          Keys.setLabel(keys);
          }
          else
          if (menuAdd.equals(DEkeys)){
              keys = "German keyboard  ";
              localkeys = "DE_DE";
          Keys.setLabel(keys);
          }
          else
          if (menuAdd.equals(ESkeys)){
              keys = "Spanish keyboard  ";
              localkeys = "ES_ES";
          Keys.setLabel(keys);
          }
  ...
  public void changeMem(){
    ...
    public void itemStateChanged(final ItemEvent e) {
      ...
      if (e.getSource() == checkFull){
            togglesize = checkFull.getState();
          FullSize();
      }

      else
      if (e.getSource() == checkSimple)
          setSimpleSized();
      else
      if (e.getSource() == checkDouble)
          setDoubleSized(true);
      else
      if (e.getSource() == checkTriple)
          setTripleSized(true);

      else
      if (e.getSource() == checkGate){
         setFullSized(true);
      }
      else
      if (e.getSource() == checkScan){
          ScanLines();
      }
            else
      if (e.getSource() == checkScan){
     ...
     /* else {
     if (hideframe == true)  {
    if (e.getStateChange() == ItemEvent.SELECTED && this.gotGames) {
      final Object item = ((JComboBox) e.getSource()).getSelectedItem();
     /* if (e.getSource() == this.jcbImage) {
        loadFile(((FileDescriptor) item).filename);
      }else */
    /*  if (e.getSource() == this.jcbDrive) {
        computer.setCurrentDrive(this.jcbDrive.getSelectedIndex());
        ...
        for (int i = 0; i < n; i++) {
          ...
          if (device instanceof UPD765A) {
            ...
            final int forcedHead = FDC.getForcedHead(this.jcbDrive.getSelectedIndex());
            this.driveHead.setSelectedIndex(forcedHead);
          }
        }
      } else
         if (e.getSource() == this.driveHead) {
        final Vector devices = computer.getDevices();
        final int n = devices.size();
        for (int i = 0; i < n; i++) {
          final Object device = devices.get(i);
          if (device instanceof UPD765A) {
            final UPD765A FDC = (UPD765A) device;
            FDC.setForcedHead(this.driveHead.getSelectedIndex(), this.jcbDrive.getSelectedIndex());
          }
        }
      }
      else {
        try {
          setComputer(((ComputerDescriptor)item).content);
  ...
  public void saveDsk() {
      ...
      frame.setAlwaysOnTop(false);
        ...
        FileDialog filedia = new FileDialog((Frame) frame, "Save DSK...", FileDialog.SAVE);
        filedia.setFile("*.dsk");
        filedia.setVisible(true);
        String filename = filedia.getFile();
        if (filename != null) {
...
//        joymenu.add(lightgun);
 ...
 protected void fsoundInit(){
  ...
  public void screenshot(){
      if (executable)
        frame.setAlwaysOnTop(false);
      images = new BufferedImage(display.getImage().getWidth(sprev), display.getImage().getHeight(sprev),  BufferedImage.SCALE_SMOOTH);
      images.getGraphics().drawImage(display.getImage(), 0,0, display.getImage().getWidth(sprev), display.getImage().getHeight(sprev), null);
...
if (!screenpreview.isVisible())
    ...
    cancelshot.setBorder(new BevelBorder(BevelBorder.RAISED));
      ...
      screenpreview.pack();
    //  screenpreview.setAlwaysOnTop(true);    //  screenpreview.setAlwaysOnTop(true);
...
if (!screenpreview.isVisible())
  ...
  public void saveShot(){
       File file;
        FileDialog shotdia = new FileDialog((Frame) frame,
       ...
       if (savename.toLowerCase().endsWith(".bmp")){
       file = new File(savename);
...
Image imagec = Toolkit.getDefaultToolkit().createImage(
  ...
  protected void askDrive(final String filename) throws Exception {
      ...
      driveA.addActionListener(new ActionListener() {
         ...
         public void actionPerformed(ActionEvent e) {
             ...
             try{
             loadFile(0,filename,false);}
             catch (Exception er){System.out.println("Error while loading");}
             ask.dispose();
         }
      });
