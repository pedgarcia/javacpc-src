...
public abstract class Computer extends Device implements Runnable, ItemListener {
  ...
  ItemEvent ev;
  /*
   * Server is your Server path, where JavaCPCWebstart.jar is located
   * for example:  http://yourdomain.com/jemu/
   */
...
/*  public abstract void BreakPoint(int breaknumber, int address);
  public abstract int getBreakPoint(int breaknumber);
